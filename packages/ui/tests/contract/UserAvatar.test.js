...
describe('UserAvatar Contract', () => {
    ...
    describe('Component Interface', () => {
        it('should accept required props with correct types', () => {
            expect(() => {
                render(_jsx(UserAvatar, { user: mockUser, size: "md" }));
            }).not.toThrow();
        });
        it('should accept optional props with correct types', () => {
            expect(() => {
                render(_jsx(UserAvatar, { user: mockUser, size: "lg", showOnlineStatus: true, onlineStatus: "online", fallbackType: "initials", className: "custom-avatar", onClick: () => { }, alt: "Custom alt text" }));
            }).not.toThrow();
        });
        it('should handle missing user gracefully', () => {
            expect(() => {
                render(_jsx(UserAvatar, { user: null, size: "md" }));
            }).not.toThrow();
        });
    });
    describe('Rendering Contract', () => {
        ...
        it('should show initials fallback when no image', () => {
            ...
            render(_jsx(UserAvatar, { user: userWithoutImage, size: "md", fallbackType: "initials" }));
        ...
        it('should show different status colors', () => {
            const { rerender } = render(_jsx(UserAvatar, { user: mockUser, size: "md", showOnlineStatus: true, onlineStatus: "online" }));
            let statusIndicator = screen.getByLabelText(/online status/i);
            expect(statusIndicator).toHaveClass('bg-green-500'); // Online
            rerender(_jsx(UserAvatar, { user: mockUser, size: "md", showOnlineStatus: true, onlineStatus: "away" }));
            statusIndicator = screen.getByLabelText(/away status/i);
            expect(statusIndicator).toHaveClass('bg-yellow-500'); // Away
            rerender(_jsx(UserAvatar, { user: mockUser, size: "md", showOnlineStatus: true, onlineStatus: "offline" }));
    ...
    describe('Interaction Contract', () => {
        it('should call onClick when avatar is clicked', () => {
            ...
            render(_jsx(UserAvatar, { user: mockUser, size: "md", onClick: onClick }));
        ...
        it('should handle image load errors gracefully', () => {
            render(_jsx(UserAvatar, { user: mockUser, size: "md", fallbackType: "initials" }));
    ...
    describe('Accessibility Contract', () => {
        it('should have no accessibility violations', async () => {
            const { container } = render(_jsx(UserAvatar, { user: mockUser, size: "md" }));
        ...
        it('should use custom alt text when provided', () => {
            render(_jsx(UserAvatar, { user: mockUser, size: "md", alt: "Custom avatar description" }));
            const avatar = screen.getByRole('img');
    ...
    describe('Widget Integration Contract', () => {
        it('should integrate with widget system', () => {
            ...
            expect(() => {
                render(_jsx(UserAvatar, { user: mockUser, size: "md", ...widgetProps }));
            }).not.toThrow();
        });
        it('should support webhook data integration', () => {
            ...
            expect(() => {
                render(_jsx(UserAvatar, { user: mockUser, size: "md", webhookData: webhookData, showOnlineStatus: true }));
            }).not.toThrow();
        });
    });
    describe('Security Contract', () => {
        ...
        it('should handle malicious image URLs safely', () => {
            ...
            expect(() => {
                render(_jsx(UserAvatar, { user: userWithMaliciousImage, size: "md", fallbackType: "initials" }));
            }).not.toThrow();
        ...
        it('should validate image URLs before loading', () => {
            ...
            render(_jsx(UserAvatar, { user: userWithInvalidImage, size: "md", fallbackType: "initials" }));
    ...
    describe('Initials Generation Contract', () => {
        ...
        it('should handle single name correctly', () => {
            ...
            render(_jsx(UserAvatar, { user: userWithSingleName, size: "md", fallbackType: "initials" }));
        ...
        it('should handle empty names by using email', () => {
            ...
            render(_jsx(UserAvatar, { user: userWithoutNames, size: "md", fallbackType: "initials" }));
